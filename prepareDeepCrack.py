...
def process_dataset(source_root, aa_data_root, aa_meta_root):
    ...
    # --- 1. 定义常量和路径 ---
    CLASS_NAME = "deep_crack"
    TRAIN_DS_NAME = "DeepCrack_Train"
    TEST_DS_NAME = "DeepCrack_Test"

    SOURCE_IMG_DIR = os.path.join(source_root, "train_img")
    SOURCE_MASK_DIR = os.path.join(source_root, "train_lab")
    ...
    split_size = int(total_count * 0.25)
    if split_size == 0:
